...
public class MainWithoutObjekt {
    ...
    public static void main(String[] args) {
        ...
        String[] allSongs = new String[] { "Boshki Dymyatsa", "Sinimi Zheltymi Krasnymi", "Highway To Hell", "Sonet",
                "Rayda", "Since U Been Gone", "La Grange", "My Heart", "Someday", "Shape Of You", "A cap", "Passport",
                "Controller", "Notebook", "Troubles", "Phone", "Ring", "Glass water", "Lemonade", "A ram zam zam",
                "MicroWave", "Room", "Alone", "Alies", "Table face", "Door opening", "bedroom", "Bless you",
                "Young and brave", "Simple", "Programming", "Summer", "poldnik", "Cause", "Sharp", "Exit", "Gift",
                "Defeat", "Winner", "Victory", "Quiz", "Fifa", "Telega", "Belly", "Knowledge", "AS far as i know",
                "Celebrate", "Person", "Dream", "English", "Disney", "Silent", "Night", "Tiger", "Amazon", "Fish",
                "Mac", "MC", "Fair", "Animoto", "Selfish", "Game", "Hi", "Bye", "See you", "Ghost", "Star", "War",
                "Yandex", "Witcher", "Loser", "End", "Sky", "Cat", "Hand", "Jewelry", "Lunch" };
        ...
        System.out.println("\n\n\n\nКакой плейлист Вы хотите создать?");
        System.out.println("1. Музыка для танцев.");
        System.out.println("2. Музыка для сна.");
        System.out.println("3. Музыка для спорта.");
        System.out.print("Сделайте свой выбор: ");
        Scanner choice = new Scanner(System.in);
        switch (choice.nextInt()) {
            case (1):
                vipPlayList = ResultPlaylist(playList, genres.get(0), genres.get(1));
                System.out.println("Популярная музыка для танцев:");
            ...
            case (2):
                ...
                System.out.println("Популярная музыка для сна:");
                System.out.println(vipPlayList);
                System.out.println(ShakeShake(vipPlayList));
                break;
            case (3):
                vipPlayList = ResultPlaylist(playList, genres.get(5), genres.get(4));
                System.out.println("Популярная музыка для спорта:");
                System.out.println(vipPlayList);
                System.out.println(ShakeShake(vipPlayList));
                break;
            default:
                System.out.println("В следующий раз сделайте корректный выбор!");
        }
    }
    ...
    public static Map<String, Integer> CreateSongNames(String[] songs) {
        ...
        for (int i = 0; i < songs.length; i++) {
            songNames.put(songs[i], (int) ((Math.random() * 101) + 1));
        }
        return songNames;
    ...
    public static List<String> ResultPlaylist(Map<String, Map<String, Integer>> MusicData, String genre1,
            String genre2) {
